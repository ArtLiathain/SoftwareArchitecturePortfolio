...
#figure(
  image("codescene_maintainability.png"),
...
#figure(
  image("dv82analysis.png"),
  caption: [Dv8 high level analysis]
)
= SonarQube
#figure(
  image("20250930_141644.png"),
  caption: [Technical debt cost]
)
#figure(
  image("20250930_141703.png"),
...
= Understand
#figure(
  image("function_understand.png"),
  caption: [Function complexity understand]
)
#figure(
  image("understand_code_language.png"),
  caption: [Coding langauge breakdown]
) 

#figure(
  image("understand_dependency_graph.png"),
  caption: [Understand code dependency graph]
)

#figure(
  image("2025-10-08-12:40:09.png", width: 80%),
  caption: []
)
